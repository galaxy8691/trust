...
pub use trust_manifest::TrustManifest;
...
/// 多文件模块图：各单元为 `(source_path, Program, SourceMap, SingleThreadedComments)`（与 [`trust_parser::ParsedModuleGraph::compile_units`] 一致）。
